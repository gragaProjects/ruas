...
function selectOption() {
   // console.log(this);
    ...
    selected_option.append(icon, phone_code);//,caretIcon

    //selected_option.querySelector('div').appendChild(caretIcon);

   // input_box.value = phone_code.innerText;
    document.getElementById('code').value = phone_code.innerText;
